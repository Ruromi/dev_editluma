...
const devSiteName = `${siteName} dev`;

export const metadata: Metadata = {
  metadataBase: new URL(siteUrl),
  title: {
    default: `${devSiteName} | AI Image Generator and Photo Enhancer`,
    template: `%s | ${devSiteName}`,
  },
  description: defaultDescription,
  openGraph: {
    title: `${devSiteName} | AI Image Generator and Photo Enhancer`,
    description: defaultDescription,
    url: siteUrl,
    siteName,
    type: "website",
